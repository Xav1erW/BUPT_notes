...
$$
I = I_0 \left(\frac{\sin \alpha}{\alpha}\right)^2 \left(\frac{\sin N \beta}{\beta}\right)^2
$$
...
* 只考虑干涉因子
  * 主极大（明纹）： $\Delta \phi = \pm 2k\pi \quad \to \quad \beta = \pm k\pi \quad d\sin \theta = \pm k \lambda$   光栅方程，只决定主极大的位置
